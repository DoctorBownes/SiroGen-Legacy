...
void Sprite::DoIt(GLuint shader)
{
    ...
    glUniform4f(ColorID, _instance->Palette[blendColor + 1 - blendColor % 2].r / 255.0f, _instance->Palette[blendColor + 1 - blendColor % 2].g / 255.0f, _instance->Palette[blendColor + 1 - blendColor % 2].b / 255.0f, 1.0f);
