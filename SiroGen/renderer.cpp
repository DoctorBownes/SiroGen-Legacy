...
void Renderer::RenderEntity(Entity* entity)
{
    ...
    //std::cout << transformedVector.x << " " << transformedVector.y << " " << transformedVector.z << " " << transformedVector.w << std::endl;
    ...
    if (entity->GetComponent<Sprite>())
    {
        ...
        glBindBuffer(GL_ARRAY_BUFFER, entity->GetComponent<Sprite>()->spritetexture);
